 ...
 */
public class COArrayDeque<E> extends AbstractCollection<E> implements CODeque<E>, Cloneable, Serializable {
	/**
	 ...
	 */
	public COArrayDeque(int numElements) {
	 ...
	 */
	public COArrayDeque(Collection<? extends E> c) {
	 ...
	 */
	public COArrayDeque<E> clone() {
		try {
			COArrayDeque<E> result = (COArrayDeque<E>) super.clone();
