...
/**
 * a copy of {@link android.os.AsyncTask}. add multithreading support for API 8
 */
public abstract class COAsyncTask<Params, Progress, Result> {
	...
	private static class SerialExecutor implements Executor {
		final COArrayDeque<Runnable> mTasks = new COArrayDeque<Runnable>();
		Runnable mActive;
	 ...
	 *             {@link COAsyncTask.Status#RUNNING} or
	 *             {@link COAsyncTask.Status#FINISHED}.
	 *
	 * @see #executeOnExecutor(java.util.concurrent.Executor, Object[])
	 * @see #execute( Runnable )
	 */
	public final COAsyncTask<Params, Progress, Result> execute(Params... params) {
	 ...
	 * @see #execute( Object[])
	 */
	public final COAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
	...
	private static class AsyncTaskResult<Data> {
		final COAsyncTask mTask;
		final Data[] mData;

		AsyncTaskResult(COAsyncTask task, Data... data) {
			mTask = task;
			mData = data;
		}
	}
